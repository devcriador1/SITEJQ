...
export const Logo = () => (
    <div className="flex flex-col items-start group">
        <span
            className="text-3xl sm:text-5xl font-bold text-primary-dark group-hover:text-primary transition-colors duration-300 dark:text-primary-light dark:group-hover:text-light"
...
export const LogoLight = () => (
     <div className="flex flex-col items-start group">
        <span
            className="text-3xl sm:text-5xl font-bold text-light group-hover:text-gray-300 transition-colors duration-300"
            style={{ fontFamily: "'Poppins', sans-serif", letterSpacing: '-0.08em' }}
        >
            ABA
        </span>
