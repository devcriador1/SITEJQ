...
export const AcademicCapIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0l-2.072-1.036A48.22 48.22 0 0112 5.093a48.22 48.22 0 019.53 4.018l-2.072 1.036M12 21a2.25 2.25 0 01-2.25-2.25H9.75a.75.75 0 01-.75-.75V11.25a.75.75 0 01.75-.75h4.5a.75.75 0 01.75.75v6.75a.75.75 0 01-.75.75h-.008a2.25 2.25 0 01-2.242 2.25z" />
    </svg>
);
export const UsersGroupIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.57-1.037 1.277-2.03 2.133-2.923a10.43 10.43 0 012.332-2.195c.523-.342.969-.641 1.353-.924a3.375 3.375 0 00-3.176-5.32c-.312.14-.6.312-.86.503a10.53 10.53 0 00-4.293 5.572c-.22.42-.415.854-.585 1.308a10.43 10.43 0 00-1.406 4.418c-.033.437-.058.88-.076 1.328a3 3 0 002.993 2.993c.448-.017.89-.042 1.328-.076.74-.058 1.458-.16 2.133-.292a10.428 10.428 0 002.332-2.195z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 13.5a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zM8.25 10.5a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z" />
    </svg>
);
